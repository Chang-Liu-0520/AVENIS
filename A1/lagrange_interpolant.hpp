...
#ifndef Lagrange_Polynomials
#define Lagrange_Polynomials
...
class Lagrange
{
 public:
  ...
  Lagrange &operator=(const Lagrange &) = delete;
  Lagrange(const std::vector<double> &support_points, const int &domain_in);
